...
void setupInventar() {
  ...
  allItems.add(new InventoryItem("Ulicno svjetlo", 30, "streetlamp.obj", 12, -0.5, 1, 2));
  allItems.add(new InventoryItem("Cesta ravna", 30, "road_straight.obj", 60, -0.05, 3, 1));
  allItems.add(new InventoryItem("Cesta skretanje", 30, "road_corner.obj", 60, -0.05, 3, 1));
  allItems.add(new InventoryItem("Cesta T raskrizje", 30, "road_tjunc.obj", 60, -0.05, 3, 1));
  ...
  allItems.add(new InventoryItem("Bolnica", 30, "hospital.obj", 7, -0.1, 1, 7));
