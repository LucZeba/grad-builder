...
void setupInventar() {
  ...
  allItems.add(new InventoryItem("Auto crveni", 15, "Car.obj", 25, 0.0, 2, 0));
  allItems.add(new InventoryItem("Bonsai", 5, "Lowpoly_tree_sample.obj", 6, 0.74, 2, 5));
  allItems.add(new InventoryItem("Velika kuća", 30, "Cyprys_House.obj", 25, 0.0, 6, 3));
  allItems.add(new InventoryItem("Bor", 5, "CartoonTree.obj", 15, 0.0, 2, 5));
  allItems.add(new InventoryItem("Ljuljacka", 1, "Swing.obj", 0.5, 0.0, 2, 7));
  allItems.add(new InventoryItem("Klupa", 1, "bench.obj", 0.3, 0.0, 1, 2));
  allItems.add(new InventoryItem("Bamboo kuća", 10, "Bambo_House.obj", 20, 0.0, 5, 3));
  allItems.add(new InventoryItem("Zgrada", 60, "building_04.obj", 70, -0.5, 8, 3));
  allItems.add(new InventoryItem("Palma", 5, "palm.obj", 7, -5, 2, 5));
  allItems.add(new InventoryItem("Rudnik", 40, "mine.obj", 12, -1, 4, 7));
  allItems.add(new InventoryItem("Ulicno svjetlo", 1, "streetlamp.obj", 12, -0.5, 1, 2));
  allItems.add(new InventoryItem("Cesta ravna", 1, "road_straight.obj", 60, -0.05, 3, 1));
  allItems.add(new InventoryItem("Cesta skretanje", 1, "road_corner.obj", 60, -0.05, 3, 1));
  allItems.add(new InventoryItem("Cesta T raskrizje", 1, "road_tjunc.obj", 60, -0.05, 3, 1));
  allItems.add(new InventoryItem("Hidrant", 2, "fire_hydrant.obj", 5, -0.1, 1, 2));
  allItems.add(new InventoryItem("Drvena ograda", 1, "woodfence.obj", 14, -0.1, 1, 4));
  allItems.add(new InventoryItem("Semafor", 1, "semafor.obj", 14, -0.1, 1, 2));
  allItems.add(new InventoryItem("Bolnica", 60, "hospital.obj", 7, -0.1, 1, 7));
  allItems.add(new InventoryItem("Bor_2", 5, "pine_2.obj", 15, -0.1, 1, 5));
  allItems.add(new InventoryItem("Cesta trava", 1, "road_grass.obj", 60, -0.05, 3, 8));
  allItems.add(new InventoryItem("Tobogan", 1, "slide.obj", 4, -0.1, 2, 4));
